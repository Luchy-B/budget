...
Clone this [repository](https://github.com/Luchy-B/budget-app.git) to your desired folder:

```sh
  git https://github.com/Luchy-B/budget-app.git
  cd Budget-App
```
...
Feel free to check the [issues page](https://github.com/Luchy-B/budget-app.git).
